...
import { registerMembre } from '../../actions/authActions';
...
this.props.registerMembre(newMembre, this.props.history);

 //console.log(newMembre);
 //axios
  //.post('/api/membre/register', newMembre)
...
Register.propTypes = {
  registerMembre: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, {registerMembre} ) (withRouter(Register));
