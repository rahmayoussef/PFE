...
import {loginMembre} from '../../actions/authActions';
import classnames from 'classnames';
 ...
 class Login extends Component {
  ...
  onSubmit(e){
   ...
   // console.log(user);
   this.props.loginMembre(membreData)
  }
...
Login.propTypes = {
  loginMembre: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, {loginMembre}) (Login);